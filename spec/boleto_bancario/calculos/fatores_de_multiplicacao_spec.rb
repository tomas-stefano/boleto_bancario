    ...
    describe FatoresDeMultiplicacao do
      ...
      context 'with factors of 2..9' do
        ...
        context 'with four digits' do
          ...
          it { is_expected.to eq [ 5, 32, 18, 8] }
        end
        ...
        context 'with bradesco documentation example' do
          ...
          it { is_expected.to eq [36, 27, 18, 81, 8, 0, 6, 10, 0, 0, 0, 0, 0, 21, 30, 0, 0, 0, 14, 63, 56, 14, 6, 15, 0, 15, 6, 0, 8, 35, 0, 0, 32, 3, 16, 81, 56, 35, 0, 0, 0, 0, 0] }
        end
        ...
        context 'with itau documentation example' do
          ...
          it { is_expected.to eq [12, 12, 2, 81, 8, 42, 36, 35, 0, 0, 0, 0, 0, 7, 12, 15, 16, 15, 2, 9, 0, 7, 12, 15, 16, 15, 12, 63, 64, 56, 0, 0, 20, 21, 2, 18, 24, 28, 30, 35, 0, 0, 0] }
        end
      end
    end
  end
