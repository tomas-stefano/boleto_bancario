  ...
  module Calculos
    describe LinhaDigitavel do
      context "using the Itau documentation example" do
        ...
        it { is_expected.to eq '34191.09123 34567.880058 71234.570001 6 16670000012345' }
      end
