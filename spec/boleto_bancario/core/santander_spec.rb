  ...
  module Core
    describe Santander do
      ...
      describe "on validations" do
        ...
        it { is_expected.to have_valid(:codigo_cedente).when('1', '12', '123', '1234567') }
        it { is_expected.not_to have_valid(:codigo_cedente).when('12345678', '123456789', nil, '') }

        it { is_expected.to have_valid(:numero_documento).when('1', '12', '123', '123456789112') }
        it { is_expected.not_to have_valid(:numero_documento).when('1234567891123', nil, '') }

        it { is_expected.to have_valid(:carteira).when('101', '102', '121', 101, 102, 121) }
