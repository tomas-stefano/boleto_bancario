  ...
  module Core
    describe Nubank do
      ...
      describe '#conta_corrente' do
        context 'when have a value' do
          subject { Nubank.new(conta_corrente: '12345') }
      ...
      describe '#numero_documento' do
        context 'when have a value' do
          subject { Nubank.new(numero_documento: '1234') }
      ...
      describe '#codigo_banco' do
        it { expect(subject.codigo_banco).to eq '260' }
      end
      ...
      describe '#agencia_codigo_cedente' do
        subject { Nubank.new(agencia: '0001', conta_corrente: '1234567890') }

        it { expect(subject.agencia_codigo_cedente).to eq '0001 / 1234567890-3' }
      end

      describe '#nosso_numero' do
        subject { Nubank.new(carteira: '1', numero_documento: '12345678') }

        it { expect(subject.nosso_numero).to eq '1/00012345678-1' }
      end

      describe '#to_partial_path' do
        it { expect(subject.to_partial_path).to eq 'boleto_bancario/nubank' }
      end
    end
  end
end
